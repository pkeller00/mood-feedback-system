        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
                        <inertia-link :href="route('home')">Got an event to join?</inertia-link>
                    </div>
                </div>
                ...
                <div class="ml-12">
                    ...
                    <form @submit.prevent="submit">
                        <div class="mt-4" >
                            <jet-label for="meeting-code" value="Enter access code" />
                            <!-- <jet-input id="name" type="text" class="mt-1 block w-full" v-model="meeting.name" required autofocus /> -->
                            <jet-input id="meeting-code" type="text" class="mt-1 block w-full" required autofocus />
            ...
            <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laracasts.com">Host a meeting</a></div>
                </div>
